  ...
  const steps = [
    {
      ...
      explanation:
        "Dans le menu principal, vous trouverez différentes catégories d’artisanat. Sélectionnez celle qui correspond à vos besoins pour voir les artisans disponibles.",
    },
    {
      title: "Étape 2 :",
      description: "Choisir un artisan dans la liste.",
      explanation:
        "Une fois la catégorie sélectionnée, parcourez la liste des artisans et choisissez celui qui vous convient le mieux en fonction de vos critères (localisation, spécialité, note, etc.).",
    },
    {
      title: "Étape 3 :",
      description: "Le contacter via le formulaire.",
      explanation:
        "Sur la page de l’artisan choisi, vous trouverez un formulaire de contact. Remplissez-le avec vos informations et votre message pour entrer en relation avec l’artisan.",
    },
    {
      title: "Étape 4 :",
      description: "Temps de réponse.",
      explanation:
        "Après avoir envoyé votre message, l’artisan vous répondra généralement sous 48 heures pour discuter de votre projet et vous fournir plus de détails.",
    },
  ];
